  ...
  srcs =
    ...
    in
    {
      "3.11-x86_64-linux" = getSrcFromPypi {
        ...
        dist = "cp311";
        hash = "sha256-nC8Na5EOk91Hu/w6pUyDlQ/2oFlVkTiS0xsDQzfYlCA=";
      };
      "3.11-aarch64-linux" = getSrcFromPypi {
        platform = "manylinux_2_27_aarch64";
        dist = "cp311";
        hash = "sha256-NJsTHIs5P+XeKqvsFTnxjGps6FaAsUXHiwaPxW1JhHI=";
      };
      "3.11-aarch64-darwin" = getSrcFromPypi {
        platform = "macosx_11_0_arm64";
        dist = "cp311";
        hash = "sha256-/wyCy5WNGA0maHRZli4mK24ckPI5kDyCU8wZAGcSTbQ=";
      };

      "3.12-x86_64-linux" = getSrcFromPypi {
        platform = "manylinux_2_27_x86_64";
        dist = "cp312";
        hash = "sha256-8831t/SEcKtUVat5qrdGQZaUzLa1JlHMLOX7J97wNYg=";
      };
      "3.12-aarch64-linux" = getSrcFromPypi {
        platform = "manylinux_2_27_aarch64";
        dist = "cp312";
        hash = "sha256-EhJmA7pHIwDGJID4bSCXLVYxQwQQOdneo0mtUQqmEjw=";
      };
      "3.12-aarch64-darwin" = getSrcFromPypi {
        platform = "macosx_11_0_arm64";
        dist = "cp312";
        hash = "sha256-ekOZx0Kch+5verHlcSxVSOz6vel07p9KEpV/6k4177g=";
      };

      "3.13-x86_64-linux" = getSrcFromPypi {
        platform = "manylinux_2_27_x86_64";
        dist = "cp313";
        hash = "sha256-uwc6EiTmWeAejTLUfAAO21LsKqi6l+wisiKLOkblwWc=";
      };
      "3.13-aarch64-linux" = getSrcFromPypi {
        platform = "manylinux_2_27_aarch64";
        dist = "cp313";
        hash = "sha256-5TIj2PaGHTPALdAjQ/pGRwBAH/U2N4TTfDNAchjjKLg=";
      };
      "3.13-aarch64-darwin" = getSrcFromPypi {
        platform = "macosx_11_0_arm64";
        dist = "cp313";
        hash = "sha256-QWchOqAPFLsNj72Q+d7XXpdvcc6Lr4w8ROBMj7gOoME=";
      };

      "3.14-x86_64-linux" = getSrcFromPypi {
        platform = "manylinux_2_27_x86_64";
        dist = "cp314";
        hash = "sha256-JrlOlkCwGWjMFLg1Pda2VA1yPzBXnHix9GpHf8SqGW0=";
      };
      "3.14-aarch64-linux" = getSrcFromPypi {
        platform = "manylinux_2_27_aarch64";
        dist = "cp314";
        hash = "sha256-k82ZiUBPhqIbUMf/ToUKMfVVCWZDEggJeL3pemZNkqk=";
      };
      "3.14-aarch64-darwin" = getSrcFromPypi {
        platform = "macosx_11_0_arm64";
        dist = "cp314";
        hash = "sha256-mmV1VNvlbzaR03fLmdALKd8U5WOOV55Xll+facMskxU=";
      };
    };
in
buildPythonPackage {
